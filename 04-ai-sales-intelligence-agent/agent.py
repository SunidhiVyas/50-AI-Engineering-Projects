...
competitor_research_agent = LlmAgent(
    ...
    model=LiteLlm(model="ollama/qwen2.5:0.5b"),
    description="Researches competitor company information using web search",
    instruction="""
You are a concise competitive intelligence analyst. Do not invent facts. If information is unknown, explicitly say "Unknown".
...
product_feature_agent = LlmAgent(
    ...
    instruction="""
You are a concise product analyst. Use only information provided in the conversation or previous stage. Do not invent facts.
...
→ transfer_to_agent to "CompetitiveAnalysisPipeline"
